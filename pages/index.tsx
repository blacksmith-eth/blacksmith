  ...
  return (
    <section className="text-black min-h-screen max-h-screen flex flex-col overflow-hidden selection:bg-black">
      ...
      <main className="bg-white flex flex-col md:flex-row flex-grow overflow-y-auto overscroll-none">
        <aside className="bg-white border-b border-black md:border-b-0 md:border-r p-2 w-full md:static md:basis-1/5 md:overflow-y-auto md:overscroll-none min-w-fit">
